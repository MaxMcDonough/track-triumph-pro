      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Start your data-driven betting journey
          </p>
        </div>
        ...
        <p className="text-xs text-muted-foreground text-center mt-6 max-w-sm mx-auto">
          By creating an account, you agree that gambling involves risk.
          Never bet more than you can afford to lose. Must be 18+.
        </p>
      </div>
    </div>
  );
