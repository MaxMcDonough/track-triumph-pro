...
db.bankroll_settings.insertOne({
  user_id: userId,
...
curl -X GET "https://your-app.com/api/bankroll" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X GET "https://your-app.com/api/tracks" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN"

curl -X POST "https://your-app.com/api/analyze" \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer YOUR_SESSION_TOKEN" \
  -d '{"track": "wolverhampton", "race_number": 1}'
```
...
db.bankroll_settings.find().limit(2).pretty();
"
...
db.bankroll_settings.deleteMany({user_id: /test-user/});
"
```
